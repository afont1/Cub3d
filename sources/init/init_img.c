...
/*   Updated: 2024/07/05 12:15:55 by afont            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	data->all_img.east_wall.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, data->all_img.east_wall.path, &data->all_img.east_wall.width, &data->all_img.east_wall.height);
	ft_protect_img(data->all_img.east_wall.img_ptr);
	data->all_img.east_wall.addr = mlx_get_data_addr(data->all_img.east_wall.img_ptr, &data->all_img.east_wall.bits_per_pixel, &data->all_img.east_wall.line_length, &data->all_img.east_wall.endian);
	data->all_img.south_wall.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, data->all_img.south_wall.path, &data->all_img.south_wall.width, &data->all_img.south_wall.height);
	ft_protect_img(data->all_img.south_wall.img_ptr);
	data->all_img.south_wall.addr = mlx_get_data_addr(data->all_img.south_wall.img_ptr, &data->all_img.south_wall.bits_per_pixel, &data->all_img.south_wall.line_length, &data->all_img.south_wall.endian);
	...
	data->all_img.floor.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, "images/floor/wall1.xpm", &data->all_img.floor.width, &data->all_img.floor.height);
	...
	data->all_img.ceiling.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, "images/ceiling/ceiling.xpm", &data->all_img.ceiling.width, &data->all_img.ceiling.height);
	ft_protect_img(data->all_img.ceiling.img_ptr);
	data->all_img.ceiling.addr = mlx_get_data_addr(data->all_img.ceiling.img_ptr, &data->all_img.ceiling.bits_per_pixel, &data->all_img.ceiling.line_length, &data->all_img.ceiling.endian);
	...
	data->all_img.deco1.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, "images/deco/deco1.xpm", &data->all_img.deco1.width, &data->all_img.deco1.height);
	ft_protect_img(data->all_img.deco1.img_ptr);
	data->all_img.deco1.addr = mlx_get_data_addr(data->all_img.deco1.img_ptr, &data->all_img.deco1.bits_per_pixel, &data->all_img.deco1.line_length, &data->all_img.deco1.endian);
	
}

void	ft_init_img3(t_data *data)
{
	data->all_img.west_wall.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, data->all_img.west_wall.path, &data->all_img.west_wall.width, &data->all_img.west_wall.height);
	ft_protect_img(data->all_img.west_wall.img_ptr);
	data->all_img.west_wall.addr = mlx_get_data_addr(data->all_img.west_wall.img_ptr, &data->all_img.west_wall.bits_per_pixel, &data->all_img.west_wall.line_length, &data->all_img.west_wall.endian);
	data->all_img.north_wall.img_ptr = mlx_xpm_file_to_image(data->mlx_ptr, data->all_img.north_wall.path, &data->all_img.north_wall.width, &data->all_img.north_wall.height);
	ft_protect_img(data->all_img.north_wall.img_ptr);
	data->all_img.north_wall.addr = mlx_get_data_addr(data->all_img.north_wall.img_ptr, &data->all_img.north_wall.bits_per_pixel, &data->all_img.north_wall.line_length, &data->all_img.north_wall.endian);
...
{
	data->all_img.env_img.img_ptr = mlx_new_image(data->mlx_ptr, WIN_WIDTH, WIN_HEIGHT);
	data->all_img.env_img.addr = mlx_get_data_addr(data->all_img.env_img.img_ptr, &data->all_img.env_img.bits_per_pixel, &data->all_img.env_img.line_length, &data->all_img.env_img.endian);
	data->map.img.img_ptr = mlx_new_image(data->mlx_ptr, data->map.size, data->map.size);
